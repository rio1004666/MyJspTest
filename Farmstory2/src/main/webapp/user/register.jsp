...
<%@ include file="../_header.jsp" %>
		...
		<section id="user" class="register">
			<!-- 회원가입 페이지에서도 form 태그로 post 데이터전송방식을 택하였습니다. 처리페이지는 registerProc.jsp에서 수행합니다. -->
